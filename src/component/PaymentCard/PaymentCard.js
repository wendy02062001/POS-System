    ...
    return (
        <div className="container" style={{ paddingTop: '20px', width: '600px' }}>
            <form className="formLog" style={{ height: '700px'}} onSubmit={formik.handleSubmit}>
                <NavLink to="/">
                    <img style={{width: '150px', height: '150px'}} className="imgLogo" src="./img/cupcake.png" alt="logo" />
                </NavLink>
                <div className="row">
                    <div className="col-12">
                        <p className="text-left">BANK SELECTION</p>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="form-group">
                            ...
                            {formik.errors.soThe && formik.touched.soThe && <p className="text text-left text-danger">{formik.errors.soThe}</p>}
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-6">
                        <div className="form-group">
                            ...
                            {formik.errors.hoTen && formik.touched.hoTen && <p className="text text-left text-danger">{formik.errors.hoTen}</p>}
                        </div>
                    </div>
                    <div className="col-6">
                        <div className="form-group">
                            ...
                            {formik.errors.ngayPhatHanh && formik.touched.ngayPhatHanh && <p className="text text-left text-danger">{formik.errors.ngayPhatHanh}</p>}
                        </div>
                    </div>
                </div>
                <div className="form-group">
